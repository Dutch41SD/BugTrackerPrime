...
namespace BugTrackerPrime.Services
{
    public class BTNotificationService : IBTNotificationService
    {
        ...
        private readonly IBTRolesService _rolesServices;

        public BTNotificationService(ApplicationDbContext context,
                              IEmailSender emailSender,
                              IBTRolesService rolesServices)
        {
            _context = context;
        ...
        public async Task SendEmailNotificationsByRoleAsync(Notification notification, int companyId, string role)
        {
            try
            {
                List<BTUser> members = await _rolesServices.GetUsersInRoleAsync(role, companyId);

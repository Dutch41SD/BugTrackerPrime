...
namespace BugTrackerPrime.Data
{
            ...
            try
            {
                IList<Project> projects = new List<Project>() {
                     new Project()
                     {
                         ...
                         EndDate = new DateTime(2023,1,20).AddMonths(1),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2023,1,20),
                         EndDate = new DateTime(2023,1,20).AddMonths(2),
                         ProjectPriorityId = priorityLow
                     },
                    new Project()
                     {
                         ...
                         StartDate = new DateTime(2023,1,20),
                         EndDate = new DateTime(2023,1,20).AddMonths(3),
                         ProjectPriorityId = priorityHigh
                     }
                };

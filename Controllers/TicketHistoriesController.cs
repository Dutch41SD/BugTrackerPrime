...
namespace BugTrackerPrime.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,Priority,OldValue,NewValue,Created,Description,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,Priority,OldValue,NewValue,Created,Description,UserId")] TicketHistory ticketHistory)
        {
